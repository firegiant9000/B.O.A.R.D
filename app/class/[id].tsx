...
// (src/components/classroom/) or classroomService, never here. Screens
// under app/ can't be render/import-tested in this Jest setup (expo-font is
// unresolvable via @expo/vector-icons, and @firebase/util ships ESM the
// transform doesn't handle), and expo-router route files aren't
// platform-excluded from a native bundle even with a `.web` extension — so
// the tested surface is always the component this file does nothing but
// render.
